...
public interface PrecoDataDAO extends DAO<PrecoData> {
    ...
    List<Float> getPrecoQuery(Integer jogo_id, Integer loja_id) throws SQLException;

    List<Date> getDataQuery(Integer jogo_id, Integer loja_id) throws SQLException;
