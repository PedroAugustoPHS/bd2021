...
<body>
    <div class="container">
        <div class="row">
            <h1>Epic</h1>
            <div class="col-12">
                <span pattern="dd-MM-yyyy">Data de leitura do menor preço: ${histL1.data_menor_preco} </span><br>
        ...
        <div class="row">
            <h1>Steam</h1>
            <div class="col-12">
                <span pattern="dd-MM-yyyy HH:mm:ss">Data de leitura do menor preço: ${histL2.data_menor_preco} </span><br>
        ...
        <div class="row">
            <h1>Nuuvem</h1>
            <div class="col-12">
                <span pattern="dd-MM-yyyy">Data de leitura do menor preço: ${histL3.data_menor_preco} </span><br>
